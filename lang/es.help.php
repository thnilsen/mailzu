...
?>
<div align="center">
    <h3><a name="top" id="top"></a>Introducci�n a MailZu</h3>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="5" style="border: solid #CCCCCC 1px">
        <tr>
            <td bgcolor="#FAFAFA">
                <ul>
                    <li><b><a href="#getting_started">Introducci�n</a></b></li>
                    <ul>
                        <li><a href="#logging_in">Iniciar sesi�n</a></li>
                        <li><a href="#language">Selecci�n de lenguage</a></li>
